  ...
  return (
    <>
      ...
      <div className="justify-content-between d-flex m-5">
        <h1>Komplekslar</h1>
        <h3>Jami: {allSections.length} ta kompleks mavjud</h3>
        <Link to="/superadmin/complex/add">
          <button className="defaultbtn">+ Yangi kompleks</button>
        </Link>
      </div>
      <div className="m-5">
        {allSections.map((section) => (
          <Card key={section._id} className="mb-3 sectionscard">
            ...
            <div className="operations justify-content-between d-flex text-end m-3">
              ...
              <div>
                <Link to={`/superadmin/complex/edit/${section._id}`}><i className="fa-solid fa-pen-to-square sectionicon sectionedit"></i></Link>
                <i
