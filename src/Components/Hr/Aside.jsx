      ...
      <div className="aside">
        ...
        <nav className="aside-menu">
          <ul>
            <li
              className={
                location.pathname === "/hr/schedule/new" ? "active" : ""
              }
            >
            ...
            <li
              className={
                location.pathname === "/hr/schedule/history" ? "active" : ""
              }
            >
            ...
            <li
              className={
                location.pathname === "/hr/info/employee" ? "active" : ""
              }
            >
            ...
            <li
              className={location.pathname === "/hr/languages" ? "active" : ""}
            >
            ...
            <li
              className={
                location.pathname === "/hr/report/global" ? "active" : ""
              }
            >
              <Link to="/hr/report/global">
            ...
            <li
              className={
                location.pathname === "/hr/report/holidays"
                  ? "active"
                  : ""
              }
            >
              <Link to="/hr/report/holidays">
