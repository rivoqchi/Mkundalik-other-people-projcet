    ...
    <>
      <Modal size='lg' backdrop="static" centered show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title><i class="fa-solid fa-triangle-exclamation"></i> Lavozim yo`riqnomangizni yuklang:</Modal.Title>
        </Modal.Header>
        <Modal.Body>Endilikda o`z lavozim yo`riqnomangizni yuklashingiz mumkin.<br/>
            <div className="text-center">
            <img className='lavozimyoriqnomasiimg' src={lavozimyoriqnomasi} alt="Lavozim yo`riqnomasi instruksiyasi" />
            </div>
        </Modal.Body>
        <Modal.Footer>
